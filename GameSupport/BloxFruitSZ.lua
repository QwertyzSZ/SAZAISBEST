...
local AF = serv:Channel("Farming", "http://www.roblox.com/asset/?id=6022668945")
    ...
    AF:Toggle("AutoFarm Monster", false, function(vu)
        ...
        if _G.AutoFarmMonster and MiscFarmWeapon == "" then
            DiscordLib:Notification("SazaSystem","Select Weapon First",3)
...
AF:Button("Refresh Weapon", function()
    ...
    local SelectWeaponEvent = AF:Dropdown("Select Weapon", Wapon,function(value)
        EventWeapon = value
    end)
...
spawn(function()
    ...
    Setting:Toggle("Auto Set Spawn Point", false, function(vu)
        AutoSetSpawn = vu
    end)
        ...
        for i = 1,math.huge do
            ...
            if _G.FastAttk then
                pcall(function()
                        ...
                        CombatFrameworkR.activeController.hitboxMagnitude = 350
                end)
            end
            game:GetService("RunService").Heartbeat:wait()
        end
            ...
            if Auto_Farm then
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    ...
                    if (CFrameQ.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 4 then
                        wait(1)
                        CheckLevel()
                        if (CFrameQ.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 50 then
                                        ...
                                        repeat game:GetService("RunService").Heartbeat:wait()
                                            if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then
                                                if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                                    EquipWeapon(SelectToolWeapon)
                                                    local HP = v.Humanoid.MaxHealth*30/100
                                                    if HP <= v.Humanoid.Health then
                                                    TP(v.HumanoidRootPart.CFrame * CFrame.new(0,0,30))
                                                    else
                                                    TP(v.HumanoidRootPart.CFrame * CFrame.new(20, 30,20))
                                                    end
                                                    v.HumanoidRootPart.CanCollide = false
            ...
            pcall(function()
                if _G.Auto_Candy then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Peanut Scout [Lv. 2075]") or game:GetService("Workspace").Enemies:FindFirstChild("Peanut President [Lv. 2100]") or game:GetService("Workspace").Enemies:FindFirstChild("Ice Cream Chef [Lv. 2125]") or game:GetService("Workspace").Enemies:FindFirstChild("Ice Cream Commander [Lv. 2150]") then
                        ...
                        CandyMagnet = false
                        WalkOnWater = true
                        TP(CFrame.new(-1466.87195, 160.776093, -10697.4375, 0.704132855, 0, -0.710068226, -0, 1, -0, 0.710068226, 0, 0.70413))
                    end
                end
            end)
        end
...
spawn(function()
    ...
    spawn(function()
        game:GetService("RunService").Stepped:Connect(function()
            if SafeMode or PlayerHunt or KillPlayer or AutoRainbow or AutoCitizen or AutoFarmBoss or FarmAllBoss or Elite or AutoThird or AutoBartilo or AutoRengoku or _G.Auto_Bone or AutoEcto or AutoFarmObservation or Auto_Farm or FarmMasteryGun or FarmMasteryFruit or EliteHunter or _G.Auto_indra_Hop or _G.Auto_Dark_Dagger_Hop or _G.AutoDonSwan_Hop or _G.Pole_Hop or Core or noclip or AutoEvoRace or TPChest or NextIsland or RaidSuperhuman or _G.AutoRaid or SelectFarm or Clip or HolyTorch or AutoFarmSelectMonster or AutoLowRaid or _G.Auto_Candy then
            ...
            pcall(function()
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    ...
                    elseif _G.Auto_Bone and BoneMagnet and Magnet then
                        if (v.Name == "Reborn Skeleton [Lv. 1975]" or v.Name == "Living Zombie [Lv. 2000]" or v.Name == "Demonic Soul [Lv. 2025]" or v.Name == "Posessed Mummy [Lv. 2050]") and (v.HumanoidRootPart.Position - MainMonBone.Position).Magnitude <= 350 then
                            v.Head.CanCollide = false
                            v.HumanoidRootPart.CanCollide = false
                            v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                    ...
                    elseif _G.Auto_Candy and CandyMagnet and Magnet then
                        if (v.Name == "Peanut Scout [Lv. 2075]" or v.Name == "Peanut President [Lv. 2100]" or v.Name == "Ice Cream Chef [Lv. 2125]" or v.Name == "Ice Cream Commander [Lv. 2150]") and (v.HumanoidRootPart.Position - MainMonCandy.Position).Magnitude <= 350 then
                            v.Head.CanCollide = false
                            v.HumanoidRootPart.CanCollide = false
                            v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                    ...
                    elseif AutoFarmSelectMonster and AutoFarmSelectMonsterMagnet and Magnet then
                        ...
                        elseif v.Name == "Monkey [Lv. 14]" then
                            if (v.HumanoidRootPart.Position - PosMonSelectMonster.Position).Magnitude <= 300 then
                                v.Head.CanCollide = false
                                v.HumanoidRootPart.CanCollide = false
                                v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                v.HumanoidRootPart.CFrame = PosMonSelectMonster
                        ...
                        elseif v.Name == Ms and (v.HumanoidRootPart.Position - PosMonSelectMonster.Position).Magnitude <= 350 then
                            v.Head.CanCollide = false
                            v.HumanoidRootPart.CanCollide = false
                            v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                            v.HumanoidRootPart.CFrame = CFrameBring
