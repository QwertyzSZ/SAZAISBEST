    ...
    elseif chestfram == false then
        ...
        while _G.autoChests do
            ...
            for i,v in pairs(AllChests()) do
                if (v.n == _G.selectchest) or (_G.selectchest == 'All') then
...
AF3:Toggle("Boost 3X Damage", false, function(autotripledamage)
   ...
   AF3:Toggle("Boost Super Lucky", false, function(autotripledamage)
      ...
      AF3:Seperator()
      AF3:Toggle("Auto Buy Merchant Slot 1", false, function(buymerchany)
        shared.toggle3buy = buymerchany
    end)
    game:GetService("RunService").Heartbeat:Connect(function()
        if shared.toggle3buy then
            local args = {
                [1] = {[1] = 1}}
    ...
    AF3:Toggle("Auto Buy Merchant Slot 2", false, function(buymerchany1)
        shared.toggle3buy1 = buymerchany1
    end)
    game:GetService("RunService").Heartbeat:Connect(function()
        if shared.toggle3buy1 then
            local args = {
                [1] = {[1] = 2}}
            workspace.__THINGS.__REMOTES:FindFirstChild("buy merchant item"):InvokeServer(unpack(args))
            wait(0.5)
    ...
    AF3:Toggle("Auto Buy Merchant Slot 3", false, function(buymerchany2)
        shared.toggle3buy2 = buymerchany2
    end)
    game:GetService("RunService").Heartbeat:Connect(function()
        if shared.toggle3buy2 then
            local args = {
                [1] = {[1] = 3}}
            workspace.__THINGS.__REMOTES:FindFirstChild("buy merchant item"):InvokeServer(unpack(args))
            wait(0.5)
...
AF4:Seperator()
AF4:Button("Remove Animation", function()
