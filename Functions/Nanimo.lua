...
function DiscordLib:Window(text)
	...
	UserCircleImage.ImageColor3 = PresetColor
    ...
    function ServerHold:Server(text, img)
        ...
        Server.BackgroundColor3 = PresetColor
    ...
    if fs == false then
        ...
        function ChannelHold:Channel(text, ico)
            ...
            ChannelBtnHashtag.TextColor3 = PresetColor
            ...
            function ChannelContent:Slider(text, min, max, start, callback)
                ...
                Zip.BackgroundColor3 = PresetColor
                ...
                ValueLabel.BackgroundColor3 = PresetColor
            ...
            function ChannelContent:Seperator()
                ...
                Seperator1.BackgroundColor3 = Color3.fromRGB(27, 27, 27)
            ...
            function ChannelContent:Label2(text)
                ...
                Label2.BackgroundColor3 = Color3.fromRGB(25,25,25)
                ...
                LabelTitle2.TextColor3 = PresetColor
...
AF:Label("|| Pixel World ||")

AF:Toggle("Pixel Vault", false, function(t)
    getgenv().Start = t
    getgenv().Area = 'Pixel Vault'
...
AF:Toggle("Pixel Kyoto", false, function(t)
    getgenv().Start = t
    getgenv().Area = 'Pixel Kyoto'
...
AF:Toggle("Pixel Alps", false, function(t)
    getgenv().Start = t
    getgenv().Area = 'Pixel Alps'
...
AF:Toggle("Pixel Forest", false, function(t)
    getgenv().Start = t
    getgenv().Area = 'Pixel Forest'
...
AF3:Toggle("Auto Redeem Gifts", false, function(vu)
    ReedemGifts = vu
end)
...
spawn(function()
    while wait(.1) do
        if ReedemGifts then
            ...
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift1.Timer.Text == "✅"
            repeat wait()
                local args = {[1] = {[1] = 2}}
                workspace.__THINGS.__REMOTES:FindFirstChild("redeem free gift"):InvokeServer(unpack(args))
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift2.Timer.Text == "✅"
            repeat wait()
                local args = {[1] = {[1] = 3}}
                workspace.__THINGS.__REMOTES:FindFirstChild("redeem free gift"):InvokeServer(unpack(args))  
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift3.Timer.Text == "✅"
            repeat wait()
                local args = {[1] = {[1] = 4}}
                workspace.__THINGS.__REMOTES:FindFirstChild("redeem free gift"):InvokeServer(unpack(args))  
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift4.Timer.Text == "✅"
            repeat wait()
                local args = {[1] = {[1] = 5}}
                workspace.__THINGS.__REMOTES:FindFirstChild("redeem free gift"):InvokeServer(unpack(args))  
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift5.Timer.Text == "✅"
            repeat wait()
                local args = {[1] = {[1] = 6}}
                workspace.__THINGS.__REMOTES:FindFirstChild("redeem free gift"):InvokeServer(unpack(args))  
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift6.Timer.Text == "✅"
            repeat wait()
                local args = {[1] = {[1] = 7}}
                workspace.__THINGS.__REMOTES:FindFirstChild("redeem free gift"):InvokeServer(unpack(args))  
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift7.Timer.Text == "✅"
            repeat wait()
                local args = {[1] = {[1] = 8}}
                workspace.__THINGS.__REMOTES:FindFirstChild("redeem free gift"):InvokeServer(unpack(args))  
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift8.Timer.Text == "✅"
            repeat wait()
                local args = {[1] = {[1] = 9}}
                workspace.__THINGS.__REMOTES:FindFirstChild("redeem free gift"):InvokeServer(unpack(args))  
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift9.Timer.Text == "✅"
            repeat wait()
                local args = {[1] = {[1] = 10}}
                workspace.__THINGS.__REMOTES:FindFirstChild("redeem free gift"):InvokeServer(unpack(args))  
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift10.Timer.Text == "✅"
            repeat wait()
                local args = {[1] = {[1] = 11}}
                workspace.__THINGS.__REMOTES:FindFirstChild("redeem free gift"):InvokeServer(unpack(args))  
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift11.Timer.Text == "✅"
            repeat wait()
                local args = {[1] = {[1] = 12}}
                workspace.__THINGS.__REMOTES:FindFirstChild("redeem free gift"):InvokeServer(unpack(args))  
            until not ReedemGifts or game:GetService("Players").LocalPlayer.PlayerGui.FreeGifts.Frame.Container.Gifts.Gift12.Timer.Text == "✅"
        end
    end
end)
AF3:Seperator()
...
AF3:Toggle("Boost 3X Damage", false, function(autotripledamage)
   ...
   AF3:Toggle("Boost Super Lucky", false, function(autotripledamage)
      ...
      AF3:Seperator()
          ...
          AF3:Dropdown("Hoverboard Skin", {"Original", "VIP", "Sleigh", "Flame", "Bling", "Blue Flying Carpet", "Red Flying Carpet", "Rainbow", "Cat", "Steampunk"}, function(vu)
...
spawn(function()
    while wait(.0000000000000001) do
...
AF4:Dropdown("Select egg", Eggs, function(egglis)
if egglis then
getgenv().Egg = egglis
end
end)
...
AF4:Toggle("Disable Hatch Animation", false,function(petanim)
    _G.PetAnima = petanim
end)
spawn(function()
    while wait() do
